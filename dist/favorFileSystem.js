...
.factory('FavorFileSystemModel',function($rootScope){
    ...
    $rootScope.$on('favorOpenFile',function(event,path){
       FileSystemObj.openFile(path); 
    });
    
    FileSystemObj.openFile = function(path){
        if(typeof FavorOpenFilesModel !='undefined' && !FavorOpenFilesModel.checkFileIsOpen || typeof FavorOpenFilesModel ==='undefined'){
